...
# XXD Panel 113｜كولاج بكسلي من شظايا الصدف
...
تستخدم النماذج التالية مراجع أصلية مختلفة. أنشأ Panel 113 كل عمل بصورة مستقلة وفي جولة توليد واحدة، وقد أزيلت البيانات الوصفية للذكاء الاصطناعي. النماذج الأفقية تقسيمها صارم 50:50: الواقع يساراً والتصميم يميناً؛ والنماذج العمودية تقسيمها صارم 50:50: الواقع أعلى والتصميم أسفل.
...
طُلب عند التوليد نص إنجليزي قصير مرتبط بالصورة الأصلية. تُعرض نتائج المحاولة الواحدة لإظهار الأسلوب وانحرافات النموذج، وليست أمثلة تستوفي جميع معايير القبول بالكامل.

الانحرافات الملحوظة: تتجاوز بعض الأمثلة بوضوح حد الأصل البالغ 200 وحدة، أو تُبقي موضوعًا أو مشهدًا أكبر من المطلوب، أو تشبه الفسيفساء المنتظمة أكثر من رقائق الصدف الخشنة، وقد تكون ألوانها خافتة أكثر من اللازم. إنها تعرض السلوك الفعلي لتوليد واحد، وليست أمثلة مستوفية لجميع معايير الأسلوب؛ لم تُجرَ توليدات إضافية.
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 113 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-113`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-113 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-113-prompt.en.md) أو [بالصينية](references/xxd-panel-113-prompt.zh-CN.md).
